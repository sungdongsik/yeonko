    ...
    <div id="warp">
        <div id="top">
            ...
            <?php 
                ...
                $a_name=$_POST['a_name'];   //브라우저에서 서버로 전송한 POST Data $_POST배열에서 꺼내서 변수에 담는 부분 
                ...
                $sql ="insert into staff values('$a_id','$a_name','$a_td','$a_mail','$a_pass','$a_tel')";  //가입정보를 insert 문으로 구성... 
