    ...
    <div id="warp">
        <div id="top">
            ...
            <?php 
                ...
                $p_name=$_POST['p_name'];   //브라우저에서 서버로 전송한 POST Data $_POST배열에서 꺼내서 변수에 담는 부분 

                $p_td_number=$_POST['p_td']; 
                ...
                $sql ="insert into professor values('$p_id','$p_name','$p_td','$p_mail','$p_pass','$p_tel')";  //가입정보를 insert 문으로 구성... 
