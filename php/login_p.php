            ...
            <div class="cont2"><img src="../img/4.jpg" alt=""></div>
             <div class="cont3">
                ...
                <?php 
                    ...
                    $sql ="select p_id,p_pass,p_name from professor where p_id='$p_id' and p_pass='$p_pass' "; 
                    ...
                    $_SESSION['logid']=$record['p_id']; 

                    echo "<H1>".$record['p_name']."님 교수로 로그인 되었습니다.<br><br></H1>";
